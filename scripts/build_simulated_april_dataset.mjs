...
const HOUSEWIFE_TASK_TEMPLATES = [
  {
    key: "home-morning-reset",
    title: "Home Morning Reset",
    startTime: "05:45",
  ...
  {
    key: "breakfast-and-lunchbox-prep",
    title: "Breakfast and Lunchbox Prep",
    startTime: "06:30",
    endTime: "07:30",
    estimatedMinutes: 60,
    breakMinutes: 0,
  ...
  {
    key: "grocery-and-meal-planning",
    title: "Grocery and Meal Planning",
    startTime: "11:00",
    endTime: "12:00",
    estimatedMinutes: 60,
    breakMinutes: 5,
  ...
  {
    key: "school-pickup-and-homework-support",
    title: "School Pickup and Homework Support",
    startTime: "15:00",
    endTime: "16:15",
    estimatedMinutes: 75,
    breakMinutes: 0,
  ...
  {
    key: "dinner-prep-and-kitchen-cleanup",
    title: "Dinner Prep and Kitchen Cleanup",
    startTime: "18:00",
    endTime: "19:15",
    estimatedMinutes: 75,
...
const HOUSEWIFE_DAY_PLANS = [
  {
    date: "2026-04-16",
    note: "A busy family day starts rough: breakfast is done, but laundry and meal planning are pushed aside.",
    outcomes: {
      "home-morning-reset": { status: "completed", actualMinutes: 52 },
      "breakfast-and-lunchbox-prep": { status: "completed", actualMinutes: 70 },
      "laundry-and-folding": { status: "missed" },
      "grocery-and-meal-planning": { status: "missed" },
      "school-pickup-and-homework-support": { status: "completed", actualMinutes: 86 },
      "dinner-prep-and-kitchen-cleanup": { status: "completed", actualMinutes: 88 },
    },
  },
  {
    date: "2026-04-17",
    note: "She handles the morning routine but misses laundry again after errands run late.",
    outcomes: {
      "home-morning-reset": { status: "completed", actualMinutes: 50 },
      "breakfast-and-lunchbox-prep": { status: "completed", actualMinutes: 68 },
      "laundry-and-folding": { status: "missed" },
      "grocery-and-meal-planning": { status: "completed", actualMinutes: 70 },
      "school-pickup-and-homework-support": { status: "completed", actualMinutes: 84 },
      "dinner-prep-and-kitchen-cleanup": { status: "completed", actualMinutes: 85 },
    },
  },
  {
    date: "2026-04-18",
    note: "Weekend chores are heavier; laundry is completed but meal planning is skipped.",
    outcomes: {
      "home-morning-reset": { status: "completed", actualMinutes: 48 },
      "breakfast-and-lunchbox-prep": { status: "completed", actualMinutes: 64 },
      "laundry-and-folding": { status: "completed", actualMinutes: 112 },
      "grocery-and-meal-planning": { status: "missed" },
      "school-pickup-and-homework-support": { status: "completed", actualMinutes: 78 },
      "dinner-prep-and-kitchen-cleanup": { status: "completed", actualMinutes: 82 },
    },
  },
  {
    date: "2026-04-19",
    note: "A family visit disrupts the home rhythm and dinner cleanup is left unfinished.",
    outcomes: {
      "home-morning-reset": { status: "completed", actualMinutes: 47 },
      "breakfast-and-lunchbox-prep": { status: "completed", actualMinutes: 63 },
      "laundry-and-folding": { status: "missed" },
      "grocery-and-meal-planning": { status: "completed", actualMinutes: 66 },
      "school-pickup-and-homework-support": { status: "completed", actualMinutes: 80 },
      "dinner-prep-and-kitchen-cleanup": { status: "missed" },
    },
  },
  {
    date: "2026-04-20",
    note: "The routine starts improving, with household planning and evening cleanup back on track.",
    outcomes: {
      "home-morning-reset": { status: "completed", actualMinutes: 46 },
      "breakfast-and-lunchbox-prep": { status: "completed", actualMinutes: 62 },
      "laundry-and-folding": { status: "completed", actualMinutes: 104 },
      "grocery-and-meal-planning": { status: "completed", actualMinutes: 63 },
      "school-pickup-and-homework-support": { status: "completed", actualMinutes: 78 },
      "dinner-prep-and-kitchen-cleanup": { status: "completed", actualMinutes: 80 },
    },
  },
  {
    date: "2026-04-21",
    note: "School pickup and homework are fine, but grocery planning slips after a clinic errand.",
    outcomes: {
      "home-morning-reset": { status: "completed", actualMinutes: 45 },
      "breakfast-and-lunchbox-prep": { status: "completed", actualMinutes: 61 },
      "laundry-and-folding": { status: "completed", actualMinutes: 100 },
      "grocery-and-meal-planning": { status: "missed" },
      "school-pickup-and-homework-support": { status: "completed", actualMinutes: 77 },
      "dinner-prep-and-kitchen-cleanup": { status: "completed", actualMinutes: 78 },
    },
  },
  {
    date: "2026-04-22",
    note: "She starts breaking chores into smaller blocks and finishes all household essentials.",
    outcomes: {
      "home-morning-reset": { status: "completed", actualMinutes: 44 },
      "breakfast-and-lunchbox-prep": { status: "completed", actualMinutes: 60 },
      "laundry-and-folding": { status: "completed", actualMinutes: 96 },
      "grocery-and-meal-planning": { status: "completed", actualMinutes: 60 },
      "school-pickup-and-homework-support": { status: "completed", actualMinutes: 76 },
      "dinner-prep-and-kitchen-cleanup": { status: "completed", actualMinutes: 77 },
    },
  },
  {
    date: "2026-04-23",
    note: "The family routine is steady, though dinner cleanup still runs a little long.",
    outcomes: {
      "home-morning-reset": { status: "completed", actualMinutes: 43 },
      "breakfast-and-lunchbox-prep": { status: "completed", actualMinutes: 59 },
      "laundry-and-folding": { status: "completed", actualMinutes: 94 },
      "grocery-and-meal-planning": { status: "completed", actualMinutes: 58 },
      "school-pickup-and-homework-support": { status: "completed", actualMinutes: 75 },
      "dinner-prep-and-kitchen-cleanup": { status: "completed", actualMinutes: 78 },
    },
  },
  {
    date: "2026-04-24",
    note: "Laundry, food planning, school pickup, and dinner cleanup all finish near estimate.",
    outcomes: {
      "home-morning-reset": { status: "completed", actualMinutes: 42 },
      "breakfast-and-lunchbox-prep": { status: "completed", actualMinutes: 58 },
      "laundry-and-folding": { status: "completed", actualMinutes: 92 },
      "grocery-and-meal-planning": { status: "completed", actualMinutes: 57 },
      "school-pickup-and-homework-support": { status: "completed", actualMinutes: 74 },
      "dinner-prep-and-kitchen-cleanup": { status: "completed", actualMinutes: 76 },
    },
  },
  {
    date: "2026-04-25",
    note: "A Saturday cleanup day is organized and completed without missed household blocks.",
    outcomes: {
      "home-morning-reset": { status: "completed", actualMinutes: 42 },
      "breakfast-and-lunchbox-prep": { status: "completed", actualMinutes: 57 },
      "laundry-and-folding": { status: "completed", actualMinutes: 91 },
      "grocery-and-meal-planning": { status: "completed", actualMinutes: 56 },
      "school-pickup-and-homework-support": { status: "completed", actualMinutes: 73 },
      "dinner-prep-and-kitchen-cleanup": { status: "completed", actualMinutes: 75 },
    },
  },
  {
    date: "2026-04-26",
    note: "Meal planning and laundry stay predictable, helping the evening routine end smoothly.",
    outcomes: {
      "home-morning-reset": { status: "completed", actualMinutes: 41 },
      "breakfast-and-lunchbox-prep": { status: "completed", actualMinutes: 56 },
      "laundry-and-folding": { status: "completed", actualMinutes: 90 },
      "grocery-and-meal-planning": { status: "completed", actualMinutes: 55 },
      "school-pickup-and-homework-support": { status: "completed", actualMinutes: 72 },
      "dinner-prep-and-kitchen-cleanup": { status: "completed", actualMinutes: 74 },
    },
  },
  {
    date: "2026-04-27",
    note: "The final day shows a recovered, realistic household routine with all core tasks completed.",
    outcomes: {
      "home-morning-reset": { status: "completed", actualMinutes: 40 },
      "breakfast-and-lunchbox-prep": { status: "completed", actualMinutes: 55 },
      "laundry-and-folding": { status: "completed", actualMinutes: 89 },
      "grocery-and-meal-planning": { status: "completed", actualMinutes: 54 },
      "school-pickup-and-homework-support": { status: "completed", actualMinutes: 72 },
      "dinner-prep-and-kitchen-cleanup": { status: "completed", actualMinutes: 73 },
    },
  },
];

const NAVY_SIDELINE_TASK_TEMPLATES = [
  {
    key: "morning-watch-briefing",
  ...
  {
    key: "equipment-maintenance-check",
  ...
  {
    key: "duty-log-and-reporting",
    title: "Duty Log and Reporting",
    startTime: "13:00",
    endTime: "13:45",
    estimatedMinutes: 45,
    breakMinutes: 0,
  ...
  {
    key: "fitness-and-uniform-prep",
    title: "Fitness and Uniform Prep",
    startTime: "17:00",
    endTime: "18:00",
    estimatedMinutes: 60,
    breakMinutes: 0,
  ...
  {
    key: "project-management-sideline",
    title: "Project Management Sideline",
    startTime: "19:00",
    endTime: "20:00",
    estimatedMinutes: 60,
    breakMinutes: 5,
  ...
  {
    key: "video-editing-client-work",
    title: "Video Editing Client Work",
    startTime: "20:30",
    endTime: "22:30",
    estimatedMinutes: 120,
    breakMinutes: 10,
...
const NAVY_SIDELINE_DAY_PLANS = [
  {
    date: "2026-04-16",
    note: "A long duty day leaves the Navy worker too tired to finish both sideline blocks.",
    outcomes: {
      "morning-watch-briefing": { status: "completed", actualMinutes: 52 },
      "equipment-maintenance-check": { status: "completed", actualMinutes: 108 },
      "duty-log-and-reporting": { status: "completed", actualMinutes: 54 },
      "fitness-and-uniform-prep": { status: "completed", actualMinutes: 72 },
      "project-management-sideline": { status: "missed" },
      "video-editing-client-work": { status: "missed" },
    },
  },
  {
    date: "2026-04-17",
    note: "The duty schedule is handled, but video editing runs too late and gets skipped.",
    outcomes: {
      "morning-watch-briefing": { status: "completed", actualMinutes: 50 },
      "equipment-maintenance-check": { status: "completed", actualMinutes: 104 },
      "duty-log-and-reporting": { status: "completed", actualMinutes: 52 },
      "fitness-and-uniform-prep": { status: "completed", actualMinutes: 68 },
      "project-management-sideline": { status: "completed", actualMinutes: 76 },
      "video-editing-client-work": { status: "missed" },
    },
  },
  {
    date: "2026-04-18",
    note: "A maintenance extension pushes the sideline project board to the next day.",
    outcomes: {
      "morning-watch-briefing": { status: "completed", actualMinutes: 49 },
      "equipment-maintenance-check": { status: "completed", actualMinutes: 114 },
      "duty-log-and-reporting": { status: "completed", actualMinutes: 51 },
      "fitness-and-uniform-prep": { status: "completed", actualMinutes: 66 },
      "project-management-sideline": { status: "missed" },
      "video-editing-client-work": { status: "completed", actualMinutes: 148 },
    },
  },
  {
    date: "2026-04-19",
    note: "He catches up on client edits, but project management notes are still uneven.",
    outcomes: {
      "morning-watch-briefing": { status: "completed", actualMinutes: 48 },
      "equipment-maintenance-check": { status: "completed", actualMinutes: 102 },
      "duty-log-and-reporting": { status: "completed", actualMinutes: 50 },
      "fitness-and-uniform-prep": { status: "missed" },
      "project-management-sideline": { status: "missed" },
      "video-editing-client-work": { status: "completed", actualMinutes: 142 },
    },
  },
  {
    date: "2026-04-20",
    note: "The schedule starts improving with cleaner duty logs and one focused editing block.",
    outcomes: {
      "morning-watch-briefing": { status: "completed", actualMinutes: 47 },
      "equipment-maintenance-check": { status: "completed", actualMinutes: 98 },
      "duty-log-and-reporting": { status: "completed", actualMinutes: 48 },
      "fitness-and-uniform-prep": { status: "completed", actualMinutes: 64 },
      "project-management-sideline": { status: "completed", actualMinutes: 70 },
      "video-editing-client-work": { status: "completed", actualMinutes: 136 },
    },
  },
  {
    date: "2026-04-21",
    note: "An urgent sideline client update is done, but video rendering is deferred.",
    outcomes: {
      "morning-watch-briefing": { status: "completed", actualMinutes: 46 },
      "equipment-maintenance-check": { status: "completed", actualMinutes: 96 },
      "duty-log-and-reporting": { status: "completed", actualMinutes: 47 },
      "fitness-and-uniform-prep": { status: "completed", actualMinutes: 62 },
      "project-management-sideline": { status: "completed", actualMinutes: 68 },
      "video-editing-client-work": { status: "missed" },
    },
  },
  {
    date: "2026-04-22",
    note: "He begins splitting off-duty work into smaller chunks and completes the whole day.",
    outcomes: {
      "morning-watch-briefing": { status: "completed", actualMinutes: 45 },
      "equipment-maintenance-check": { status: "completed", actualMinutes: 94 },
      "duty-log-and-reporting": { status: "completed", actualMinutes: 46 },
      "fitness-and-uniform-prep": { status: "completed", actualMinutes: 61 },
      "project-management-sideline": { status: "completed", actualMinutes: 65 },
      "video-editing-client-work": { status: "completed", actualMinutes: 128 },
    },
  },
  {
    date: "2026-04-23",
    note: "Duty tasks stay stable and the sideline work fits better after dinner.",
    outcomes: {
      "morning-watch-briefing": { status: "completed", actualMinutes: 45 },
      "equipment-maintenance-check": { status: "completed", actualMinutes: 92 },
      "duty-log-and-reporting": { status: "completed", actualMinutes: 45 },
      "fitness-and-uniform-prep": { status: "completed", actualMinutes: 60 },
      "project-management-sideline": { status: "completed", actualMinutes: 63 },
      "video-editing-client-work": { status: "completed", actualMinutes: 124 },
    },
  },
  {
    date: "2026-04-24",
    note: "Maintenance, reporting, project tracking, and video edits all finish close to estimate.",
    outcomes: {
      "morning-watch-briefing": { status: "completed", actualMinutes: 44 },
      "equipment-maintenance-check": { status: "completed", actualMinutes: 91 },
      "duty-log-and-reporting": { status: "completed", actualMinutes: 45 },
      "fitness-and-uniform-prep": { status: "completed", actualMinutes: 59 },
      "project-management-sideline": { status: "completed", actualMinutes: 62 },
      "video-editing-client-work": { status: "completed", actualMinutes: 122 },
    },
  },
  {
    date: "2026-04-25",
    note: "The sideline project board is updated before editing, avoiding the earlier late-night misses.",
    outcomes: {
      "morning-watch-briefing": { status: "completed", actualMinutes: 44 },
      "equipment-maintenance-check": { status: "completed", actualMinutes: 90 },
      "duty-log-and-reporting": { status: "completed", actualMinutes: 44 },
      "fitness-and-uniform-prep": { status: "completed", actualMinutes: 59 },
      "project-management-sideline": { status: "completed", actualMinutes: 60 },
      "video-editing-client-work": { status: "completed", actualMinutes: 119 },
    },
  },
  {
    date: "2026-04-26",
    note: "A lighter watch day gives enough room for focused client editing and planning.",
    outcomes: {
      "morning-watch-briefing": { status: "completed", actualMinutes: 43 },
      "equipment-maintenance-check": { status: "completed", actualMinutes: 89 },
      "duty-log-and-reporting": { status: "completed", actualMinutes: 44 },
      "fitness-and-uniform-prep": { status: "completed", actualMinutes: 58 },
      "project-management-sideline": { status: "completed", actualMinutes: 59 },
      "video-editing-client-work": { status: "completed", actualMinutes: 117 },
    },
  },
  {
    date: "2026-04-27",
    note: "The final simulated day shows a recovered balance between Navy duty and sideline work.",
    outcomes: {
      "morning-watch-briefing": { status: "completed", actualMinutes: 43 },
      "equipment-maintenance-check": { status: "completed", actualMinutes: 88 },
      "duty-log-and-reporting": { status: "completed", actualMinutes: 43 },
      "fitness-and-uniform-prep": { status: "completed", actualMinutes: 58 },
      "project-management-sideline": { status: "completed", actualMinutes: 58 },
      "video-editing-client-work": { status: "completed", actualMinutes: 116 },
    },
  },
];
...
const USER_SCENARIOS = {
  ...
  pZWUaFWrxnbHox5USIQOyuUyMAH3: {
    label: "Housewife household routine improvement dataset",
    description:
      "Simulated April 16 to April 27 housewife routine with morning reset, breakfast and lunchbox prep, laundry, grocery planning, school pickup, homework support, dinner prep, and kitchen cleanup.",
    taskTemplates: HOUSEWIFE_TASK_TEMPLATES,
    dayPlans: HOUSEWIFE_DAY_PLANS,
  },
  b7eoxXTj45baMZjuwHtjUuO3k3o1: {
    label: "Navy duty and sideline project work improvement dataset",
    description:
      "Simulated April 16 to April 27 Navy routine with watch briefings, maintenance checks, duty reporting, fitness prep, plus off-duty project management and video editing sideline work.",
    taskTemplates: NAVY_SIDELINE_TASK_TEMPLATES,
    dayPlans: NAVY_SIDELINE_DAY_PLANS,
  },
};
